(function draw_graph(){
  ...
  d3.json("simple_force_graph/prunedBigGraph.json", function(error, graph) {
  ...
  ///
      ...
      node
          ...
          .attr("stroke", "#ddd")
          ///Different Stroke Widths to split Registered
     ...
     function mouseOut(){
      ...
      var elmnt = document.getElementById("graph_scroll");
      elmnt.scrollLeft = 1300;
      elmnt.scrollTop = 1700;
